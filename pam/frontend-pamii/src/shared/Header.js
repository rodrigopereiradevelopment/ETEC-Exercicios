...
<ion-item button class="menu-item" data-url="/produto/cad">
    <ion-label>Cad. Produto</ion-label>
</ion-item>
<ion-item button class="menu-item" data-url="/produto/edit">
    <ion-label>Editar Produto</ion-label>
</ion-item>
<ion-item button class="menu-item" data-url="/usuario/list">
    <ion-label>Usuários</ion-label>
</ion-item>
<ion-item button class="menu-item" data-url="/usuario/cad">
    <ion-label>Cad. Usuário</ion-label>
</ion-item>
<ion-item button class="menu-item" data-url="/usuario/edit">
    <ion-label>Editar Usuário</ion-label>
</ion-item>
            </ion-list>
        </ion-content>
    `;
